...
当你成功使用盾击命中目标时，以一个直觉动作，你能引导光能治愈自己每神话阶层1d6点生命值，超出上限的生命值会以临时生命的形式保存，持续到你的下一回合开始为止。
...
每轮一次，以一个标准动作，你对一个目标降下光之标记，持续到战斗结束或mu'biao'si'wan。在持续期间，你对目标造成武器伤害的一半会治疗你自身。如果你有圣骑士的“制裁邪恶”能力，则你可以作为“制裁邪恶”动作的一部分降下光之印记，并且印记的持续时间和你的“制裁邪恶”时间相同。
