...
以迅捷动作，你能进入一种冷酷的杀戮状态。在这种状态下，你的基础移速获得30尺亵渎加值。每当你的近战攻击成功命中一个生物后，你就能移动至多30尺，该移动不消耗任何动作，也不触发被命中敌人的借机攻击。你每通过该方式移动50尺，所有针对你的任何攻击就会承受10%的失手率。分裂攻击、杀意涌动和无所畏惧不能同时开启。
</br>
...
当你同时持用一面盾牌和一件可单手持用的武器时，以一个标准动作，你能作出两次盾击攻击动作。
* 剑盾之怒Ex（2级）![图片](https://github.com/LeoZhang421/Tyranny-Age-of-the-Miracle/assets/102232196/25f07a8a-b258-4ffc-bcf5-438b51093c24)
</br>
每轮一次，当敌人对你的近战攻击失手，你可以以借机攻击用盾牌发动反击。
...
每轮一次，以一个迅捷动作，你对一个目标降下光之标记，持续一轮。在持续期间，你对目标造成武器伤害的一半会治疗你自身。如果你有圣骑士的“制裁邪恶”能力，则你可以作为“制裁邪恶”动作的一部分降下光之印记，并且印记的持续时间和你的“制裁邪恶”时间相同。
