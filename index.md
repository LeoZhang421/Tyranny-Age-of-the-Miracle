...
*能力树：反射神经*</br>
*使用你的反应力闪避和反击。*
* 强制击落Ex（1级）![图片](https://user-images.githubusercontent.com/102232196/182348493-d4d3ca95-4644-4a82-94e6-25dcc6d9acd6.png)</br>
...
你的反应提升到令人难以置信的水平，你可以使用强制击落拦截对你发起的近战攻击。
* 哨兵Ex（3级）![图片](https://user-images.githubusercontent.com/102232196/182348596-0513df5b-4e6c-4e6b-b20f-c8dcb0490473.png))</br>
以一个整轮动作，发射命中后在15尺半径内爆裂的射击，除了主目标外其他范围内的生物可以通过一个反射豁免减半伤害。你对所有受到了爆裂射击伤害的生物添加狩猎标记。
* 逃脱Ex（4级）![图片](https://user-images.githubusercontent.com/102232196/182348666-edee2656-3379-4046-892a-94b129bd0fe3.png)</br>
你的远程攻击能同时攻击所有射程范围内被你添加了狩猎标记的敌人，你同时攻击的狩猎标记每超过一，1个，你的攻击加值就额外-2。你对所有狩猎标记的同一次攻击只进行一次攻击检定，分别对抗目标的AC。
</br>
