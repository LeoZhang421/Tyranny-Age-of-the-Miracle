...
在走投无路的局面下，你鼓舞自己，集中精力于对手的每一次进攻，让你能承受原本致命的伤害，但是这会使你无法移动。 每天一次以自由动作启动，持续神话阶层轮，你免疫因生命值伤害而造成的死亡，且不论你的生命值有多低，你都能存活且维持意识清醒，在此期间你无法主动移动。你能以一个标准动作关闭该能力。
</br>
...
你对物体造成伤害时能无视其前20点硬度，如果你成功击碎了一块物体，那么它会爆碎，并对半径10尺内的生物造成你每神话阶层d8点钝击&穿刺伤害，成功通过反射豁免则减半。
...
*能力树：射击训练*</br>
*通用射击技巧。*
* 稳固射击Ex（1级）![图片](https://user-images.githubusercontent.com/102232196/182181412-7ed55190-f9ae-4b6d-8b33-ffa8c4b1863d.png)</br>
以一个迅捷动作，你可以对一个目标添加狩猎标记，狩猎标记持续到其死亡或者你主动将其清除。你对被你标记目标发起的所有远程攻击获得+2的洞察加值。
...
你的远程攻击能同时攻击射程范围内所有被你添加了狩猎标记的敌人，你每同时攻击额外一个目标，你在这次攻击上就额外-2。你对所有标记目标的单次攻击只进行一次攻击检定，分别对抗目标的AC。
</br>

*能力树：强化箭*</br>
*使用不同的箭矢、弹药攻击你的目标。*
* 爆头Ex（1级）使用不同的箭矢、弹药攻击你的目标。</br>
以一个标准动作发动远程攻击，你能对被你狩猎标记的目标头部发射穿透性的弹药，并且清除目标的标记。目标必须要有头，若命中，则这次攻击自动造成重击威胁。
* 齐射Ex（2级）![图片](https://user-images.githubusercontent.com/102232196/182531414-318eefd1-6dce-4dbc-898e-ec29591882dc.png)</br>
当用弩矢远程攻击一个被你标记的目标时，你可以清除该标记并将目标钉在其周围的物体上。取代一次远程攻击，你对一个身处坚实平面邻接位置的敌人进行一次远程的阴招战技攻击，并在计算战技攻击加值时使用你的敏捷调整值而非力量调整值。如果战技攻击成功，那么敌人的一部分肢体被钉在该平面上。目标将无法离开目前占据的位置，除非他通过一个DC=（你的战技攻击检定结果）的力量检定才能再次移动。
* 精准射击Ex（3级）![图片](https://user-images.githubusercontent.com/102232196/182183319-f095eebc-e9aa-443a-a186-0595726d0a31.png)</br>
以一个整轮动作，发射命中后在15尺半径内爆裂的射击，除了主目标外其他范围内的生物可以通过一个反射豁免减半伤害。你对所有受到了爆裂射击伤害的敌人添加狩猎标记。
* 靶心Ex（4级）![图片](https://user-images.githubusercontent.com/102232196/182183378-0ec370cb-278e-4caa-bd8b-0e693563c322.png)</br>
你的远程攻击能同时攻击射程范围内所有被你添加了狩猎标记的敌人，你每同时攻击额外一个目标，你在这次攻击上就额外-2。你对所有标记目标的单次攻击只进行一次攻击检定，分别对抗目标的AC。
</br>
...
* 致残射击Ex（3级）![图片](https://user-images.githubusercontent.com/102232196/182533956-c9423d00-0767-4e66-be84-29cb645f3215.png)</br>
你放弃的攻击不仅可以用来拦截攻击，还可以在你下一回合开始前，以一个直觉动作攻击一个重新选定的目标。
* 靶心Ex（4级）![图片](https://user-images.githubusercontent.com/102232196/182534001-59258acb-033c-4730-84e2-70108775d779.png)</br>
你在脱逃，特技，平衡，飞行检定上获得等同于神话阶层的加值。
</br>
